...
<body>
    <div class="form-container">
        ...
        <div class="form-group">
            ...
            <input type="text" name="txt_Dis" id="txt_Dis" required oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '')" 
            title="Please enter only letters for the district name">
        </div>
